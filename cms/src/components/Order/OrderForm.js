			...
			<div className="w-75 mx-auto">
				<Widget>
					...
					>
						<div className='mb-3'>
							<div className="row ">
								<p className='col-12 mb-2 col-md-6'><span style={ { fontWeight: 600 } }>Thời gian tạo: </span>{ customDate( orderInfo?.created_at, 'DD/MM/yyyy' ) }</p>
								<p className='col-12 mb-2 col-md-6'><span style={ { fontWeight: 600 } }>Thời gian cập nhật: </span>{ customDate( orderInfo?.updated_at, 'DD/MM/yyyy' ) }</p>
							</div>
