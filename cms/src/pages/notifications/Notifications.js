      ...
      <Row className="gutter mb-4">
        <Col xs={12} lg={4}>
          <Widget className="widget-p-md">
            <div className="headline-2">Tuỳ chọn Giao diện</div>
            <div className={s.widgetText}>Có một số tùy chọn vị trí có sẵn cho thông báo. Bạn có thể nhấp vào bất kỳ trong số chúng để thay đổi vị trí thông báo:</div>
        ...
        <Col xs={12} lg={4} className="mt-4 mt-lg-0">
          <Widget className="widget-p-md">
            <div className="headline-2">Các loại thông báo</div>
            <div className={s.widgetText}>Các loại thông báo khác nhau cho nhiều trường hợp sử dụng. Các lớp tùy chỉnh cũng được hỗ trợ.</div>
            ...
            >
              <div className="d-flex">
                ...
                <div className="ml-2 body-2">Tin nhắn mặc định</div>
              </div>
              <img src={closeIcon} alt="..."/>
            </Button>
            <div className=" headline-3 mt-4 mb-2">Tin nhắn không có biểu tượng</div>
            <Button
              color="primary"
              className="notification-btn"
              onClick={() => {
